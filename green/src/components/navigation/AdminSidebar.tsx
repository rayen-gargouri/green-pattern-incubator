import { BarChart3, Database, FolderKanban, LayoutDashboard, UsersRound } from "lucide-react";
import Link from "next/link";

const links = [
  { href: "/admin/dashboard", label: "Vue generale", icon: LayoutDashboard },
  { href: "/admin/users", label: "Utilisateurs", icon: UsersRound },
  { href: "/admin/projects", label: "Projets", icon: FolderKanban },
  { href: "/admin/resources-management", label: "Ressources", icon: Database },
...
export function AdminSidebar() {
  return (
    <aside className="border-b bg-white lg:min-h-screen lg:w-72 lg:border-b-0 lg:border-r">
      <div className="flex h-16 items-center px-5 font-semibold text-slate-800">Green Admin</div>
